...
def main():
    ...
    configs = {
        "4": {"class": [4, 4, 4, 4, 4], "results": []},
        "8": {"class": [8, 8, 8, 8, 8], "results": []},
        "16": {"class": [16, 16, 16, 16, 16], "results": []},
        "32": {"class": [32, 32, 32, 32, 32], "results": []},
    }
    ...
    with open("results/mnist_hidden_layers_relu.pkl", "wb") as f:
